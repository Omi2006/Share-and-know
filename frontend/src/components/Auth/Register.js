    ...
    return (
        <Row style={{ margin: '15px' }}>
            <Col md='12'>
                ...
                <img src={ShareImage} alt='Share online' style={{ width: '40vw', padding: '20px' }} />
            </Col>
            <Col md='12'>
                ...
                <form style={{padding: '10px'}} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type='submit' value='Register' aria-label='register' ref={submitButton} className='btn btn-primary'/>
                </form>
            </Col>
        </Row>
    )
