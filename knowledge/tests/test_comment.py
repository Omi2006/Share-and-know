...
class CommentTestCase(APITestCase):
    def setUp(self):
        ...
        Post.objects.create(
            title='Test2', content='Test2', poster=u2, uuid='EFGH', hub=h1
        )
        ...
        self.assertDictEqual(
            loads(response.content),
            {
                'errors': {
                    ...
                    'post': ['This field may not be null.'],
                }
            },
        )
    ...
    def test_edit_comment(self):
        ...
        self.assertDictEqual(
            loads(response.content), {'message': 'Comment edited successfully'}
        )
    ...
    def test_edit_comment_other_user(self):
        ...
        self.assertDictEqual(
            loads(response.content),
            {'errors': {'comment': 'You can not edit this post!'}},
        )
